                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 py-5">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="#" class="px-2 font-raleway font-size-14">20.534 ratings | 1000+ answered
                                questions</a>
                        </div>
                        <hr class="m-0">
                        <!-- product price -->
                        <table class="my-3">
                            ...
                            <tr class="font-raleway font-size-14">
                                <td>Deal Price</td>
                                <td class="font-size-20 text-danger">&nbsp;<span>$<?php echo $item['item_price']??0; ?></span>
                                ...
                                <div class="qty d-flex">
                                    ...
                                    <div class="px-4 d-flex font-raleway">
                                        ...
                                        <input type="text" data-id="pro1"
                                               class="qty_input border px-2 w-50 bg-light text-center" disabled
                    ...
                    <div class="col-12">
                        ...
                        <p class="font-raleway font-size-14">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                            Consectetur, aspernatur dicta. Reprehenderit nostrum reiciendis ducimus autem natus non
                            voluptate repudiandae ab, nemo tenetur modi quos odit dolores unde esse assumenda!</p>
                        <p class="font-raleway font-size-14">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                            Consectetur, aspernatur dicta. Reprehenderit nostrum reiciendis ducimus autem natus non
                            voluptate repudiandae ab, nemo tenetur modi quos odit dolores unde esse assumenda!</p>
                    </div>
